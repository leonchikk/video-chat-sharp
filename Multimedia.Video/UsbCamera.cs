...
namespace Multimedia.Video
{
    ...
    {
        private Timer _fpsTime { get; set; }
        ...
        public event Action<NewFrameEventArgs> NewFrame;
        ...
        public static VideoDeviceInfo[] FindDevices()
        {
        ...
        /// </param>
        public UsbCamera(int cameraIndex, Size size, int fps = 30) : this(cameraIndex, new VideoFormat() { Size = size }, fps)
        {
        }
        ...
        /// </param>
        public UsbCamera(int cameraIndex, VideoFormat format, int fps)
        {
        ...
        private void Init(int index, VideoFormat format)
        {
            ...
            _fpsTime = new Timer(1000 / Fps);
            _fpsTime.Elapsed += (s, ev) =>
            {
                var bmp = GetBitmap();
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    NewFrame?.Invoke(new NewFrameEventArgs(ms.ToArray()));
                }
            };
            _fpsTime.Start();
    ...
    static class DirectShow
    {
        ...
        public static List<VideoDeviceInfo> GetFiltes(Guid category)
        {
            ...
            EnumMonikers(category, (moniker, prop) =>
            {
                ...
                moniker.GetDisplayName(null, null, out string monikerName);

                result.Add(new VideoDeviceInfo(0, name, monikerName));
